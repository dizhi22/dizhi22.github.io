...
var newestUrls = [
    'https://' + getRandomString() + '.esimkws.com',    
    'https://' + getRandomString() + '.esimkws.com',
    'https://' + getRandomString() + '.dzzvoml.org',    
    'https://' + getRandomString() + '.dzzvoml.org',
	'https://' + getRandomString() + '.quempei.com',    
    'https://' + getRandomString() + '.quempei.com',
    'https://' + getRandomString() + '.qzkncjsj.com',
    'https://' + getRandomString() + '.qzkncjsj.com',
    'https://' + getRandomString() + '.keqktfqu.com',
	'https://' + getRandomString() + '.keqktfqu.com',
	'https://' + getRandomString() + '.keqktfqu.com',
    'https://d3ekwyly6r9iur.cloudfront.net',
	'https://dnjtwtgi48217.cloudfront.net'
];
var otherUrls = [
...
var notices = [
	...
	'* 大陆地区用户我们强烈建议您截图收藏当前页面(dizhi8.pages.dev)。'
];
